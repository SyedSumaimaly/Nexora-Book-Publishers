...
const BusinessBookGhostwritingBanner = () => {
    return (
        <section
            style={{
                backgroundImage: `url(${InnerBanner})`,
                backgroundSize: 'cover', // Optional but usually needed for banners
                    ...
                    <div className="w-full lg:px-56 px-12 2xl-px-0 text-center">
                        ...
                        <div className="w-full flex justify-center space-x-4 mt-12">
                            <div className="list-none">
                                ...
                                >
                                    <img src={chatIcon} alt="Chatting icon" /> Let's Discuss!
                                </a>
                            </div>
                        </div>
                        <div className="flex justify-center items-center gap-5 mt-12">
                            <a href="#">
                                <img src={csuit} alt="csuit award" className="w-[81px] h-[81px]" />
                            </a>
                            <a href="#">
                                <img
                                    src={bestselleingimage}
                                    alt="Readers Favorite Silver Award"
                                    className="w-[81px] h-[81px]"
                                />
                            </a>
                            <a href="#">
                                <img src={awardIconnTwo} alt="second award" className="w-[81px] h-[81px]" />
                            </a>
                        </div>
                    </div>
                </div>
...
export default BusinessBookGhostwritingBanner;