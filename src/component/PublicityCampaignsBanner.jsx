...
const PublicityCampaignsBanner = () => {
    return (
        <section
                ...
                <div className="md:flex items-center">
                    <div className="w-full lg:px-56 px-6 2xl-px-0 text-center">
                        ...
                        <p
                            ...
                            data-cursor="-opaque -mb -color-white"
                        >
                            Get noticed. Get reviewed. Get sold. Our publicity experts know the ropes. We'll craft a
                            publicity campaign that'll have everyone talking - LIKE FOR REAL!
                        </p>
                        ...
                        <div className="flex justify-center items-center gap-5 mt-12">
                            <a href="void:;">
                                <img src={csuitSrc} alt="Award badge 1" className="w-[81px] h-[81px]" />
                            </a>
                            <a href="void:;">
                                <img
                            ...
                            <a href="void:;">
                                <img src={awardTwoSrc} alt="Award badge 3" className="w-[81px] h-[81px]" />
                            </a>
                        </div>
                    </div>
                </div>
...
export default PublicityCampaignsBanner;