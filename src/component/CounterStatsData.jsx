...
const CounterStats = () => {
    ...
    return (
        ...
        <section
            className="container mx-auto pb-10 pt-16 xl:py-20 bg-[#006341]"
            id="counter-stats"
        >
            ...
            <div className="flex justify-between md:flex-row flex-col md:space-y-0 space-y-5 px-2 md:px-4">
                {counterStatsData.map((stat, index) => (
                    <div key={index} className="text-center leading-10">
                        ...
                        <h1 className="xl:text-[50px] lg:text-[40px] text-[24px] text-[#ffffff] luxury-regular">
                        ...
                        <p className="xl:text-[17px] text-[14px] manifest-regular leading-tight text-[#dbdbdb] font-light pt-2">
                            {stat.description}
                        </p>
                    </div>
                ))}
