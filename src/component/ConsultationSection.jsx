...
import mainImage from '../assets/de.png';

const ConsultationSection = () => {

    const handleDiscussClick = (e) => {
        e.preventDefault();
        console.log("Open Modal logic triggered");
    };
                ...
                <div className="flex items-start lg:items-center justify-between lg:flex-row flex-col">
                    ...
                    <div className="w-full lg:w-1/2">
                        <h2 className="luxury-regular text-white lg:text-[53px] leading-tight mb-4 text-[25px]">
                            An Epic Title for An Epic Tale
                        </h2>
                        <p className="manifest-regular text-[#A7A7A7] text-base leading-[28px]">
                            When you have worked so hard and long on something, it's only fair that you see it through. Even
                            some of the best writers still struggle to write the perfect cover copy for their books. That's
                            why it's best to leave it to the pros. So, what are you waiting
                            for? Pick up that phone and give us a call!
                        </p>
                        ...
                        <div className="w-full max-w-[310px] my-10">
                            ...
                            >
                                ...
                                <input
                                    type="email"
                                    className="bg-transparent w-full text-white placeholder-opacity-50 placeholder-[#767677] outline-none border-0 font-light manifest-regular"
