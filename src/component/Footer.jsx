        ...
        <>
            <footer className="bg-[#1D1D1F] py-10 px-4 lg:px-2 relative overflow-hidden">
                <div className="mx-auto container max-w-7xl">
                    ...
                    <hr className="w-full mt-4 lg:hidden h-px bg-[#C1C1C1]/20 border-0" />
            ...
            <footer className={`w-full ${bgColor} py-4 border-t border-gray-600`}>
                <div className="container mx-auto px-4 flex justify-center items-center h-full">

                    {/* Content */}
                    <div className={`text-center ${textColor} text-sm font-light`}>
                        <p>© {currentYear} Nexora Book Publishers. All Rights Reserved.</p>
                        <p className="manifest-regular pt-1 text-gray-400">Powered by SayPro</p>
                    </div>
